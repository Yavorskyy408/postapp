...
class AllPersonVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    //    MARK: Check database for has new user
    func observeUsers() {
        let postRef = Database.database().reference().child("users/profile")
